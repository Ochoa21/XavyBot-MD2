...
export default function chatsimsimi(message, languageCode, sensor) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const response = yield axios.post("https://api.simsimi.vn/v2/simtalk", options, {
                headers: {
            ...
            if (sensor) {
                const censoredText = ZBadWord.sensor(res.message);
            ...
            if (sensor && message) {
                const censoredText = ZBadWord.sensor(message);
