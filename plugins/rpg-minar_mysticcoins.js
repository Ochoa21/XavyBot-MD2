...
const handler = async (m, {conn, isPrems}) => { // lastmiming
  ...
  const tradutor = _translate.plugins.rpg_minar_ochoacoins
  ...
  await conn.sendFile(m.chat, pp, 'ochoa.jpg', text, m);
  user.lastcoins = new Date * 1;
};
handler.help = ['minar2'];
handler.tags = ['gata'];
handler.command = ['minar2', 'miming2', 'mine2', 'minarochoacoins', 'minarcoins', 'minarochoa'];
handler.fail = null;
handler.exp = 0;
