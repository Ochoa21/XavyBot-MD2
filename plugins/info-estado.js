...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[1]} Ochoa
  ${tradutor.texto1[2]} +573146224366
  ${tradutor.texto1[3]} neki papi
  ...
  ${tradutor.texto1[21]} ${os.platform()}
  ...
  const Message = {
    ...
    contextInfo: {
      ...
      externalAdReply: {
        ...
        thumbnail: imagen1,
        sourceUrl: "https://github.com/Ochoa21/XavyBot-MD",
      },
    },
    caption: info,
    footer: wm,
